...
export default defineConfig({
  ...
  shortcuts: {
    ...
    'tq-btn-ghost': 'inline-flex items-center justify-center gap-2 px-14px py-10px rounded-none bg-transparent text-danger font-600 ring-1 ring-line active:opacity-80 text-[var(--tq-text-sm)] sm:text-14px',
